...
def test_setup(writeout_file, timestamp_utc):
    ...
    for d in c:
        # os.system('chmod +x chopshop/bootstrap.sh')
        # os.system('chmod +x chopshop/remote0.sh')
        # os.system('chmod +x chopshop/remote1.sh')
        # os.system('chmod +x chopshop/remote2.sh')
        # os.system('scp /home/kenso/Projects/setup/chopshop/bootstrap.sh root@{d}:/root/'.format(d=d))
        # os.system('scp /home/kenso/Projects/setup/chopshop/remote0.sh root@{d}:/root/'.format(d=d))
        # os.system('scp /home/kenso/Projects/setup/chopshop/remote1.sh root@{d}:/root/'.format(d=d))
        # os.system('scp /home/kenso/Projects/setup/chopshop/remote2.sh root@{d}:/root/'.format(d=d))
        ...
        # os.system('ssh root@{d}'.format(d=d))

        # os.system('./remote0.sh')
        # os.system('./remote1.sh')
        # os.system('exit')
        # os.system('sh -c \'echo "kensotrabing:swordfish" > /home/kenso/Projects/setup/.credentials\'')
        # os.system('scp /home/kenso/Projects/setup/.credentials root@{d}:/home/kensotrabing/'.format(d=d))
        # os.system('ssh root@{d}'.format(d=d))
        # os.system('./remote2.sh')
