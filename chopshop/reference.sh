...
# ~ your email address (hereafter: kenso.trabing@outlook.com)                               #
# ~ your server's internet protocol address (hereafter: 159.89.35.212)         #
# ~ your server's name (hereafter: wordpress)                                 #
#                                                                              #
# Be advised:                                                                  #
# ~ kensotrabing must be a string that is not "root"                          #
# ~ swordfish should be a string that is longer than eight characters      #
...
sh -c 'echo "kensotrabing:swordfish" >> .credentials'
...
scp .ssh/id_rsa.pub root@159.89.35.212:/etc/ssh/kensotrabing/authorized_keys

scp .credentials root@159.89.35.212:/home/kensotrabing/
...
CREATE USER kensotrabing WITH PASSWORD 'swordfish';

CREATE DATABASE master OWNER kensotrabing;
